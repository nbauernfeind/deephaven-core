    ...
    public interface SourceIdFieldType {
      ...
      public interface TicketFieldType {
        ...
        public interface GetTicketUnionType {
          @JsOverlay
          static FetchTableRequest.ToObjectReturnType.SourceIdFieldType.TicketFieldType
                  .GetTicketUnionType
              of(Object o) {
            return Js.cast(o);
          }
        ...
        @JsProperty
        FetchTableRequest.ToObjectReturnType.SourceIdFieldType.TicketFieldType.GetTicketUnionType
            getTicket();

        @JsProperty
        void setTicket(
            FetchTableRequest.ToObjectReturnType.SourceIdFieldType.TicketFieldType
                    .GetTicketUnionType
                ticket);
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface SourceIdFieldType {
      ...
      public interface TicketFieldType {
        ...
        public interface GetTicketUnionType {
          @JsOverlay
          static FetchTableRequest.ToObjectReturnType0.SourceIdFieldType.TicketFieldType
                  .GetTicketUnionType
              of(Object o) {
            return Js.cast(o);
          }
        ...
        @JsProperty
        FetchTableRequest.ToObjectReturnType0.SourceIdFieldType.TicketFieldType.GetTicketUnionType
            getTicket();

        @JsProperty
        void setTicket(
            FetchTableRequest.ToObjectReturnType0.SourceIdFieldType.TicketFieldType
                    .GetTicketUnionType
                ticket);
