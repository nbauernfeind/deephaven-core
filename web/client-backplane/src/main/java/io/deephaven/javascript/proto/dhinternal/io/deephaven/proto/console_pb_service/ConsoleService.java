...
public class ConsoleService {
  ...
  public interface CancelCommandType {
    @JsOverlay
    static ConsoleService.CancelCommandType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
  ...
  @JsType(isNative = true, name = "?", namespace = JsPackage.GLOBAL)
  public interface ChangeDocumentType {
    @JsOverlay
    static ConsoleService.ChangeDocumentType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
  ...
  @JsType(isNative = true, name = "?", namespace = JsPackage.GLOBAL)
  public interface CloseDocumentType {
    @JsOverlay
    static ConsoleService.CloseDocumentType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
  ...
  public interface ExecuteCommandType {
    @JsOverlay
    static ConsoleService.ExecuteCommandType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
  ...
  @JsType(isNative = true, name = "?", namespace = JsPackage.GLOBAL)
  public interface GetCompletionItemsType {
    @JsOverlay
    static ConsoleService.GetCompletionItemsType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
  ...
  public interface StartConsoleType {
    @JsOverlay
    static ConsoleService.StartConsoleType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
  ...
  public interface SubscribeToLogsType {
    @JsOverlay
    static ConsoleService.SubscribeToLogsType create() {
      return Js.uncheckedCast(JsPropertyMap.of());
    }
