...
public class SumByBenchmark {
    ...
    public Table sumByStatic(@NotNull final Blackhole bh) {
        final Table result =
                UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> table.sumBy(keyColumnNames));
        bh.consume(result);
    ...
    public Table sumByIncremental(@NotNull final Blackhole bh) {
        final Table result = IncrementalBenchmark.incrementalBenchmark(
                (t) -> UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> t.sumBy(keyColumnNames)),
                table);
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
    ...
    public Table minByStatic(@NotNull final Blackhole bh) {
        final Table result =
                UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> table.minBy(keyColumnNames));
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
    ...
    public Table minByIncremental(@NotNull final Blackhole bh) {
        final Table result = IncrementalBenchmark.incrementalBenchmark(
                (t) -> UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> t.minBy(keyColumnNames)),
                table);
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
    ...
    public Table minMaxByStatic(@NotNull final Blackhole bh) {
        ...
        final Table result = UpdateContext.updateGraphProcessor().sharedLock()
    ...
    public Table minMaxByIncremental(@NotNull final Blackhole bh) {
        ...
        final Table result = IncrementalBenchmark.incrementalBenchmark(
                (t) -> UpdateContext.updateGraphProcessor().sharedLock()
    ...
    public Table varByStatic(@NotNull final Blackhole bh) {
        final Table result =
                UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> table.varBy(keyColumnNames));
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
    ...
    public Table varByIncremental(@NotNull final Blackhole bh) {
        final Table result = IncrementalBenchmark.incrementalBenchmark(
                (t) -> UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> t.varBy(keyColumnNames)),
                table);
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
    ...
    public Table avgByStatic(@NotNull final Blackhole bh) {
        final Table result =
                UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> table.avgBy(keyColumnNames));
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
    ...
    public Table avgByIncremental(@NotNull final Blackhole bh) {
        final Table result = IncrementalBenchmark.incrementalBenchmark(
                (t) -> UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> t.avgBy(keyColumnNames)),
                table);
        bh.consume(result);
        return state.setResult(TableTools.emptyTable(0));
    }
