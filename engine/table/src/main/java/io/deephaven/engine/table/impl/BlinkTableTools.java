...
public class BlinkTableTools {
    ...
    private static class BlinkToAppendOnlyOperation implements QueryTable.MemoizableOperation<QueryTable> {
        ...
        public Result<QueryTable> initialize(boolean usePrev, long beforeClock) {
            ...
            appendRows(usePrev ? parent.getRowSet().prev() : parent.getRowSet(), usePrev);
        ...
        private void ensureCapacity(long totalSize) {
            Arrays.stream(destColumns).forEach(c -> c.ensureCapacity(totalSize));
        }
