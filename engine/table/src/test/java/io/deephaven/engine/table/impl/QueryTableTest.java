...
public class QueryTableTest extends QueryTableTestBase {
    ...
    public void testWhereInScope() {
        ...
        UpdateContext.updateGraphProcessor().exclusiveLock().doLocked(setScope::close);
        ...
        UpdateContext.updateGraphProcessor().exclusiveLock().doLocked(singletonManager::release);
