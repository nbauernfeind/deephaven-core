...
public class TestFreezeBy extends RefreshingTableTestCase {
    ...
    public void testNoKeys() {
        ...
        final Table originalExpect = UpdateContext.updateGraphProcessor().sharedLock().computeLocked(input::snapshot);
        ...
        showWithRowSet(frozen);
        final Table newExpect = UpdateContext.updateGraphProcessor().sharedLock().computeLocked(input::snapshot);
