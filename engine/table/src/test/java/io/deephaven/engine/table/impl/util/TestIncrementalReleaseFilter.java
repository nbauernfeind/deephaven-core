...
public class TestIncrementalReleaseFilter extends RefreshingTableTestCase {
    ...
    public void testAutoTune2() {
        ...
        final Table updated =
                UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> filtered.update("I=ii"));
    ...
    private int testAutoTuneCycle(int cycleTime) {
        ...
        final Table updated = UpdateContext.updateGraphProcessor().sharedLock().computeLocked(() -> filtered
