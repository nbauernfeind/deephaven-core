    ...
    public void testUngroupAgnosticRebase() {
        ...
        try {
            ...
            EvalNugget[] en = new EvalNugget[] {
                    new EvalNugget() {
                        public Table e() {
                            return UpdateContext.updateGraphProcessor().exclusiveLock().computeLocked(table::ungroup);
                        }
                    },
            };
            ...
            en = new EvalNugget[] {
                    new EvalNugget() {
                        public Table e() {
                            return UpdateContext.updateGraphProcessor().exclusiveLock().computeLocked(table2::ungroup);
                        }
                    },
            };
