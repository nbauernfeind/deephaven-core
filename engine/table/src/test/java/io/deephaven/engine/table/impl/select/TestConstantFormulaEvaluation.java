...
public class TestConstantFormulaEvaluation {
    ...
    public void testRefreshingTableForConstantFormulaColumnSource() {
        ...
        QueryTable table2 = UpdateContext.updateGraphProcessor().sharedLock().computeLocked(
        ...
        QueryTable table3 = UpdateContext.updateGraphProcessor().sharedLock().computeLocked(
